...
Hyo's Memo
------------------------------------------------------------------------------------
🎯 BJ 2798: 블랙잭 - Combinations 활용 풀이

💡 핵심 개념
- itertools.combinations 조합 라이브러리 활용
- 합계 계산 및 최댓값 찾기
- 조건부 갱신 로직

⏱️ 시간 복잡도
- combinations 생성: O(nC3)
- 각 조합 합계 계산: O(1)
- 전체: O(n³)
...
⚠️ 주의사항
- 3개의 정수의 합이 M을 초과하지 않아야 함
- 가능한 한 M과 가까운 값을 찾아야 함
- N은 3 이상이어야 함
